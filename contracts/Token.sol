...
contract Token is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant marketingReserve = 4_000_000_000 * (10 ** _decimals);
  uint256 public constant stakingReserve = 3_000_000_000 * (10 ** _decimals);
  uint256 public constant projectFundsReserve = 3_000_000_000 * (10 ** _decimals);
  uint256 public constant liquidityReserve = 2_000_000_000 * (10 ** _decimals);
